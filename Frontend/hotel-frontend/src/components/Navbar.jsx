...
function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md border-b border-gray-200 dark:border-gray-700 shadow-sm">
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center h-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <button
            ...
            className="px-3 py-1 border rounded-md border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-800 transition"
          >
            {darkMode ? "☀️" : "🌙"}
          </button>
        ...
        <button
          ...
          className="md:hidden flex flex-col justify-center items-center w-10 h-10 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition"
        >
        ...
        <div className="md:hidden bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 px-4 py-4 flex flex-col gap-3">
          ...
          {!token || isAuthPage ? (
            ...
            <>
              ...
              {/* MOBILE PROFILE WITH IMAGE */}
              <Link
                to="/profile"
                className="flex items-center gap-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-800 px-2 rounded"
              >
          ...
          <button
            onClick={() => setDarkMode(!darkMode)}
            className="px-3 py-2 border rounded-md border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-800 transition"
          >
